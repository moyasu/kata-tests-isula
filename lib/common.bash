...
clean_env()
{
	...
	containers_running=$(sudo timeout ${KATA_DOCKER_TIMEOUT} isula ps -q)
	...
	if [ ! -z "$containers_running" ]; then
		...
		sudo timeout ${KATA_DOCKER_TIMEOUT} isula kill $containers_running

		# Remove all containers
		#sudo timeout ${KATA_DOCKER_TIMEOUT} docker rm -f $(docker ps -qa)
		sudo timeout ${KATA_DOCKER_TIMEOUT} isula rm -f $(docker ps -qa)
	fi
}
